...
Export-Certificate -Cert $Cert -FilePath C:\GitHub\NAVUpgrade\Customer\Incadea\FastFit\cert
...
Write-Host "Copy the certificate (C:\GitHub\NAVUpgrade\Customer\Incadea\FastFit\cert) to the local machine"